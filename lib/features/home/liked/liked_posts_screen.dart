  ...
  Widget _buildPostsList(bool isDark) {
    ...
    return postsAsync.when(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return FadeTransition(
                ...
                child: _LikedPostCard(post: posts[index]),
              );
            },
          ),
        );
      ...
      loading: () => ListView.builder(
        padding: const EdgeInsets.only(bottom: 120),
        itemCount: 4,
        itemBuilder: (_, __) => const _LikedPostCardShimmer(),
      ),
      error: (err, _) => Center(
        child: Column(
...
class _LikedPostCardShimmer extends StatelessWidget {
  const _LikedPostCardShimmer();
