...
class AiInterviewMain extends StatefulWidget {
  const AiInterviewMain({super.key});

  @override
  State<AiInterviewMain> createState() => _AiInterviewMainState();
}

class _AiInterviewMainState extends State<AiInterviewMain> {
  @override
