...
class UnifiedInterviewSetupPage extends ConsumerStatefulWidget {
  final int initialTabIndex;

  const UnifiedInterviewSetupPage({super.key, this.initialTabIndex = 0});

  @override
  ConsumerState<UnifiedInterviewSetupPage> createState() =>
      _UnifiedInterviewSetupPageState();
}

class _UnifiedInterviewSetupPageState
    extends ConsumerState<UnifiedInterviewSetupPage>
  ...
  Widget _buildTabTitles(AiTheme t) {
    final isResumeMode = _tabController.index == 1;
    return Padding(
      ...
      child: Column(
        ...
        children: [
          _buildModeChip(t, isResumeMode),
          const SizedBox(height: 16),
          Text(
            isResumeMode ? 'Targeted' : 'Practice Session',
            style: TextStyle(
              color: t.textPrimary,
              fontSize: 32,
          ...
          Text(
            isResumeMode ? 'Interview Prep' : 'Preview Details',
            style: TextStyle(
              color: isResumeMode
          ...
          Text(
            isResumeMode
                ? 'Upload your resume and we\'ll tailor questions specifically to your background.'
  ...
  Widget _buildModeChip(AiTheme t, bool isResumeMode) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 8),
          Text(
            isResumeMode ? 'RESUME ANALYSIS ACTIVE' : 'AI INTELLIGENCE ENGINE',
            style: TextStyle(
  ...
  Widget _buildContentCard(AiTheme t) {
    final isResumeMode = _tabController.index == 1;
    final primaryColor = isResumeMode
        ? const Color(0xFF3B82F6)
        : const Color(0xFF2962FF);
      ...
      child: Column(
        ...
        children: [
          if (isResumeMode) ...[
            ...
            const SizedBox(height: 16),
            _buildUploadArea(t, primaryColor),
            const SizedBox(height: 32),
            _buildSectionHeader(
              t,
            ...
            const SizedBox(height: 16),
            _buildSearchBar(t, primaryColor),
            const SizedBox(height: 16),
            _buildChips(t, primaryColor),
            const SizedBox(height: 32),
            _buildSectionHeader(
              t,
          ...
          const SizedBox(height: 16),
          _buildPreferencesRows(t, primaryColor),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              setState(() => _selectedSkills.remove(label));
            },
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              isSelected ? _selectedFile!.name : 'Tap to pick your resume',
              textAlign: .center,
              style: TextStyle(
