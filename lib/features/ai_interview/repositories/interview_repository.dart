...
class InterviewRepository {
  ...
  /// Get LiveKit token for the interview session
  Future<String> getSessionLivekitToken(String sessionId) async {
    final response = await _dio.get('/interview/livekit-token/$sessionId');
    final data = response.data as Map<String, dynamic>;
    return data['token'] as String;
  }

  /// Get LiveKit coach token for the interview session
  Future<String> getSessionLivekitCoachToken(String sessionId) async {
    final response = await _dio.get(
      '/interview/livekit-coach-token/$sessionId',
    );
    final data = response.data as Map<String, dynamic>;
    return data['token'] as String;
  }
